...
inspirational resources of building a static website with org-mode.

- [[https://www.redblobgames.com/][Red Blob Games]] :: Creating interactive tutorials using org-mode (TODO)
...
(setq package-user-dir (expand-file-name "elisp/.packages" venikx.com-root))
...
(defun venikx.com-build-head (contents info)
  (concat
   "")
  (sxml-to-xml
   `(head
